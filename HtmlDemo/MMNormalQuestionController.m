...
- (void)viewDidLoad {
    [super viewDidLoad];
//    
//    self.NaviTitle.text = @"常见问题";
    self.title = @"预览";
    UIWebView *web = [[UIWebView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHeight - 0)];
//    UIWebView *web = [[UIWebView alloc] initWithFrame:CGRectMake(0, 0, 595, 841 - 0)];
    [self.view addSubview:web];
    _webView = web;
//    NSURL *url = [NSURL URLWithString:@"https://nhyl.teligen.net:82/frame/app_mm/index.html"];
...
//    NSURLRequest *res = [NSURLRequest requestWithURL:urll];
